...
// Only combos containing an Ace are in the hero's reach range. All non-Ace
// classes must remain explicitly unreachable, never converted to FOLD.
...
const capture={
  schema_version:'gtowizard-upi-capture-v1',id:'zero-reach-selftest',format:'SPIN_3MAX',payout_profile:'TEST',effective_stack_bb:15,hero_position:'BTN',
  history:[{actor:'BTN',type:'RAISE',to_bb:2},{actor:'SB',type:'JAM',to_bb:15}],
  source:{provider:'GTO Wizard',solution_family:'SELFTEST',node_id:'ZERO_REACH_SELFTEST'},
  full_range_upi:full,
  actions:[
    {id:'FOLD',type:'FOLD',range_upi:''},
    {id:'CALL',type:'CALL',range_upi:call},
    {id:'JAM_TO_15BB',type:'JAM',to_bb:15,range_upi:jam}
  ]
};
...
console.log('Zero-reach importer test PASS: excluded hands remain strategy:null; no invented fold/default action.');
